            ...
            <el-card>
                ...
                <div>
                    ...
                    <div style="display: flex;align-items: center">
                        <span style="font-weight: bold">答题：</span><el-link type="primary" :href="'{:api_url('/question/examination/answer_records',['examination_id'=>''])}'+examination_answer.examination_id">{{examination_answer.title}}</el-link>
                    </div>
                </div>
